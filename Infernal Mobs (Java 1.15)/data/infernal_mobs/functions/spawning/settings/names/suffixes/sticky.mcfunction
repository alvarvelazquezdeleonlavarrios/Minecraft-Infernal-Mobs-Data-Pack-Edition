...
scoreboard objectives add _tmp.rndSuf.stk dummy
scoreboard players set @s _tmp.rndSuf.stk -1
...
execute store result score @s _tmp.rndSuf.stk run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_suffix_sticky, limit=1] UUIDLeast 0.00000000023283064365386962890625
scoreboard players operation @s _tmp.rndSuf.stk %= $Constants _const.4
...
execute if score @s _tmp.rndSuf.stk matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofSnagging","interpret":true}'
execute if score @s _tmp.rndSuf.stk matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theQuickFingered","interpret":true}'
execute if score @s _tmp.rndSuf.stk matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" ofPettyTheft","interpret":true}'
execute if score @s _tmp.rndSuf.stk matches 3 run data modify block ~ ~ ~ Text2 set value '{"text":" yoink","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
scoreboard objectives remove _tmp.rndSuf.stk
