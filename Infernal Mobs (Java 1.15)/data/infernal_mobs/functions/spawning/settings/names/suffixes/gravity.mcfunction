...
scoreboard objectives add _tmp.rndSuf.grvt dummy
scoreboard players set @s _tmp.rndSuf.grvt -1
...
execute store result score @s _tmp.rndSuf.grvt run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_suffix_gravity, limit=1] UUIDLeast 0.00000000023283064365386962890625
scoreboard players operation @s _tmp.rndSuf.grvt %= $Constants _const.2
...
execute if score @s _tmp.rndSuf.grvt matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofRepulsion","interpret":true}'
execute if score @s _tmp.rndSuf.grvt matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theFlipper","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
scoreboard objectives remove _tmp.rndSuf.grvt
