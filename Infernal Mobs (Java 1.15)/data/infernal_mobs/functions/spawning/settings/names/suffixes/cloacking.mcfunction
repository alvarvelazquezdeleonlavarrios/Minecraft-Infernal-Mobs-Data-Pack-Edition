...
scoreboard objectives add _tmp.rndSuf.clck dummy
scoreboard players set @s _tmp.rndSuf.clck -1
...
execute store result score @s _tmp.rndSuf.clck run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_suffix_cloacking, limit=1] UUIDLeast 0.00000000023283064365386962890625
scoreboard players operation @s _tmp.rndSuf.clck %= $Constants _const.3
...
execute if score @s _tmp.rndSuf.clck matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofStalking","interpret":true}'
execute if score @s _tmp.rndSuf.clck matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theUnseen","interpret":true}'
execute if score @s _tmp.rndSuf.clck matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" thePredator","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
scoreboard objectives remove _tmp.rndSuf.clck
