...
scoreboard objectives add _tmp.rndPre.brsk dummy
scoreboard players set @s _tmp.rndPre.brsk -1
...
execute store result score @s _tmp.rndPre.brsk run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_prefix_berserk, limit=1] UUIDLeast 0.00000000023283064365386962890625
scoreboard players operation @s _tmp.rndPre.brsk %= $Constants _const.3
...
execute if score @s _tmp.rndPre.brsk matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"reckless ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.rndPre.brsk matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"raging ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.rndPre.brsk matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"smashing ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
scoreboard objectives remove _tmp.rndPre.brsk
