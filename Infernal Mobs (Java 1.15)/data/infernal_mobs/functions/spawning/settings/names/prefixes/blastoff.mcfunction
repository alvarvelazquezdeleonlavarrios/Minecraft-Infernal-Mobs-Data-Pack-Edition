...
scoreboard objectives add _tmp.rndPre.blst dummy
scoreboard players set @s _tmp.rndPre.blst -1
...
execute store result score @s _tmp.rndPre.blst run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_prefix_blastoff, limit=1] UUIDLeast 0.00000000023283064365386962890625
scoreboard players operation @s _tmp.rndPre.blst %= $Constants _const.3
...
execute if score @s _tmp.rndPre.blst matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"thumping ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.rndPre.blst matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"trolling ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.rndPre.blst matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"byebye ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
scoreboard objectives remove _tmp.rndPre.blst
