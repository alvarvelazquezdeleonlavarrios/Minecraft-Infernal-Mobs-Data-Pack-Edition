...
execute store result score @s _tmp.rndPre.rgn run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_prefix_regen, limit=1] UUIDLeast 0.00000000023283064365386962890625
