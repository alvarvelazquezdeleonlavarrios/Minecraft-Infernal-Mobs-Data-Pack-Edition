...
scoreboard objectives add _tmp.rndPre.blw dummy
scoreboard players set @s _tmp.rndPre.blw -1
...
execute store result score @s _tmp.rndPre.blw run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_prefix_bulwark, limit=1] UUIDLeast 0.00000000023283064365386962890625
scoreboard players operation @s _tmp.rndPre.blw %= $Constants _const.3
...
execute if score @s _tmp.rndPre.blw matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"turtling ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.rndPre.blw matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"defensive ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.rndPre.blw matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"armoured ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
scoreboard objectives remove _tmp.rndPre.blw
