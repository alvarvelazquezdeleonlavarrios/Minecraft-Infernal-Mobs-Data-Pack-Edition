...
# mob.tmp_random_prefix_value = Random.Range(0,25);
summon area_effect_cloud ~ ~ ~ {Tags:["random_uuid","random_prefix"]}
execute store result score @s _tmp.rndPre.val run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_prefix, limit=1] UUIDLeast 0.00000000023283064365386962890625
scoreboard players operation @s _tmp.rndPre.val %= $Constants _const.26
...
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 17 && mob.tags.Find("sapper") == true):
#   sign.text2 = setPrefix( sapper );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 17 if entity @s[tag=sapper] run function infernal_mobs:spawning/settings/names/prefixes/sapper

#------- If this mob has the Sprint skill, randomly chooses a prefix name of this skill -------
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 18 && mob.tags.Find("sprint") == true):
#   sign.text2 = setPrefix( sprint );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 18 if entity @s[tag=sprint] run function infernal_mobs:spawning/settings/names/prefixes/sprint

#------- If this mob has the Sticky skill, randomly chooses a prefix name of this skill -------
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 19 && mob.tags.Find("sticky") == true):
#   sign.text2 = setPrefix( sticky );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 19 if entity @s[tag=sticky] run function infernal_mobs:spawning/settings/names/prefixes/sticky

#------- If this mob has the Storm skill, randomly chooses a prefix name of this skill -------
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 20 && mob.tags.Find("storm") == true):
#   sign.text2 = setPrefix( storm );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 20 if entity @s[tag=storm] run function infernal_mobs:spawning/settings/names/prefixes/storm

#------- If this mob has the Unyielding skill, randomly chooses a prefix name of this skill -------
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 21 && mob.tags.Find("unyielding") == true):
#   sign.text2 = setPrefix( unyielding );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 21 if entity @s[tag=unyielding] run function infernal_mobs:spawning/settings/names/prefixes/unyielding

#------- If this mob has the Vengeance skill, randomly chooses a prefix name of this skill -------
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 22 && mob.tags.Find("vengeance") == true):
#   sign.text2 = setPrefix( vengeance );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 22 if entity @s[tag=vengeance] run function infernal_mobs:spawning/settings/names/prefixes/vengeance

#------- If this mob has the Weakness skill, randomly chooses a prefix name of this skill -------
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 23 && mob.tags.Find("weakness") == true):
#   sign.text2 = setPrefix( weakness );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 23 if entity @s[tag=weakness] run function infernal_mobs:spawning/settings/names/prefixes/weakness

#------- If this mob has the Webber skill, randomly chooses a prefix name of this skill -------
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 24 && mob.tags.Find("webber") == true):
#   sign.text2 = setPrefix( webber );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 24 if entity @s[tag=webber] run function infernal_mobs:spawning/settings/names/prefixes/webber

#------- If this mob has the Wither skill, randomly chooses a prefix name of this skill -------
# if (mob.tmp_random_prefix_found == false && mob.tmp_random_prefix_value == 25 && mob.tags.Find("wither") == true):
#   sign.text2 = setPrefix( wither );
execute if score @s _tmp.rndPre.fnd matches 0 if score @s _tmp.rndPre.val matches 25 if entity @s[tag=wither] run function infernal_mobs:spawning/settings/names/prefixes/wither
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
