...
scoreboard objectives add _numPly.crt.neth dummy
scoreboard objectives add _numPly.crt.end dummy
scoreboard objectives add _numPly.prv.neth dummy
scoreboard objectives add _numPly.prv.end dummy
...
tellraw @a {"text": "--------------- Infernal Mobs Data Pack -------------","color":"dark_red"}
tellraw @a {"text": "----------------- For Java Edition 1.15 --------------","color":"red"}
