...
execute if score @s _tmp.random_suffix.fiery matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofConflagration","interpret":true}'
execute if score @s _tmp.random_suffix.fiery matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" thePhoenix","interpret":true}'
execute if score @s _tmp.random_suffix.fiery matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" ofCrispyness","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
