...
execute if score @s _tmp.random_suffix.blastoff matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofMissionControl","interpret":true}'
execute if score @s _tmp.random_suffix.blastoff matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theNASA","interpret":true}'
execute if score @s _tmp.random_suffix.blastoff matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" ofWEE","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
