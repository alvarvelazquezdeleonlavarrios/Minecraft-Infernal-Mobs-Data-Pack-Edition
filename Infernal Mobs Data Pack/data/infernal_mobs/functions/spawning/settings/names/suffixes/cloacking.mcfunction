...
execute if score @s _tmp.random_suffix.cloacking matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofStalking","interpret":true}'
execute if score @s _tmp.random_suffix.cloacking matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theUnseen","interpret":true}'
execute if score @s _tmp.random_suffix.cloacking matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" thePredator","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
