...
execute if score @s _tmp.random_prefix.fiery matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"burning ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.fiery matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"toasting ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
