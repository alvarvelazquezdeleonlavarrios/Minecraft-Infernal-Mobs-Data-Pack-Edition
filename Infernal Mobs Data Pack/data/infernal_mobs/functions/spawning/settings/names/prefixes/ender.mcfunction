...
execute if score @s _tmp.random_prefix.ender matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"enderborn ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.ender matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"tricky ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
