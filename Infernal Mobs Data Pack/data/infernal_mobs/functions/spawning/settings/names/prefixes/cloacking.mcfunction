...
execute if score @s _tmp.random_prefix.cloacking matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"stalking ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.cloacking matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"unseen ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.cloacking matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"hunting ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
