...
execute if score @s _tmp.random_prefix.ninja matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"totallyzen ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.ninja matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"innerlypeaceful ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.ninja matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"Ronin ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
