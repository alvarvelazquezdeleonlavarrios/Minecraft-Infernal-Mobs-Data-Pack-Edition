...
# mob.tmp_random_prefix_unyielding = Random.Range(0,1);
...
scoreboard players operation @s _tmp.random_prefix.unyielding %= $Constants _const.2
...
#   case 1:     sign.text2 = "strong " + sign.text2;     break;
execute if score @s _tmp.random_prefix.unyielding matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"heavy ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.unyielding matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"strong ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
