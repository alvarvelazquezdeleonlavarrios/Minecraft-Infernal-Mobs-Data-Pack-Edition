#******************* Spawning --> Settings --> Variants --> Set Ultra *******************
...
#------- Adds the new tags "Infernal_Mob" and "ultra" for this mob, to identify it during the game -------
...
#++++++++++++++++++++++ Increase Mob's Health and Max Health (Ultra Variant) ++++++++++++++++++++++++++++
...
#------- Increases the mob's health in a 160% -------
# mob.tmp_health_multiplier = (mob.health / 10) * 16;
...
scoreboard players operation @s _tmp.health_multiplier *= $Constants _const.16
...
#++++++++++++++++++ Sets Mob's default Attack Damage (Ultra Variant) +++++++++++++++++++++++
execute if entity @s[type=zombie] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:4}]}
