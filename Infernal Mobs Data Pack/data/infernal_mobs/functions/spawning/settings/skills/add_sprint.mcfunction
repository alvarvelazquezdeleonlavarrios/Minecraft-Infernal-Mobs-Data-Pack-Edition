...
#------- Increases the mob's movement speed in 0.15 -------
# mob.tmp_current_movement_speed = mob.movement_speed * 100;
# mob.tmp_current_movement_speed = mob.tmp_current_movement_speed + 15;
...
scoreboard players add @s _tmp.current_movement_speed 15
