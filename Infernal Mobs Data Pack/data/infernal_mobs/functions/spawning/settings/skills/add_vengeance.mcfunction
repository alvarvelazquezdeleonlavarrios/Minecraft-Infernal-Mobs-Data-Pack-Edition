...
scoreboard players set @s _skills.vengeance.max_time 90
scoreboard players set @s _skills.vengeance.current_time 0
...
execute store result score @s _skills.vengeance.current_time run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=add_vengeance, limit=1] UUID[0] 1
