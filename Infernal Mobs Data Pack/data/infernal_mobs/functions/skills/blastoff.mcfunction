...
execute as @p[gamemode=survival, distance=..40] at @s positioned ~ ~2000.45 ~ run function infernal_mobs:skills/internal_logic/physics/apply_force_to_player
...
execute as @p[gamemode=survival, distance=..40] at @s run playsound minecraft:entity.player.attack.nodamage block @a[distance=..40] ~ ~ ~ 2
