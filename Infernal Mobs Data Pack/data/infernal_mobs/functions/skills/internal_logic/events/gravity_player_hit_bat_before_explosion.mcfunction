...
scoreboard objectives add _tmp.gravity.player_initial_pos_x dummy
scoreboard objectives add _tmp.gravity.player_initial_pos_y dummy
scoreboard objectives add _tmp.gravity.player_initial_pos_z dummy
...
# player.AddVariable( _tmp_gravity_player_initial_pos_y, 0 );
scoreboard players set @s _tmp.gravity.player_initial_pos_x 0
scoreboard players set @s _tmp.gravity.player_initial_pos_y 0
scoreboard players set @s _tmp.gravity.player_initial_pos_z 0
...
execute store result score @s _tmp.gravity.player_initial_pos_x run data get entity @s Pos[0]
execute store result score @s _tmp.gravity.player_initial_pos_y run data get entity @s Pos[1]
execute store result score @s _tmp.gravity.player_initial_pos_z run data get entity @s Pos[2]
