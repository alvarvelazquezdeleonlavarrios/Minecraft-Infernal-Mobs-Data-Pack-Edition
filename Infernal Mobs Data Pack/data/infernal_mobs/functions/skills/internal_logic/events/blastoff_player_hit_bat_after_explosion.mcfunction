...
execute store result entity @e[type=area_effect_cloud, tag=blastoff_initial_position, limit=1, sort=nearest] Pos[0] double 1 run scoreboard players get @s _tmp.blastoff.player_initial_pos_x
execute store result entity @e[type=area_effect_cloud, tag=blastoff_initial_position, limit=1, sort=nearest] Pos[1] double 1 run scoreboard players get @s _tmp.blastoff.player_initial_pos_y
execute store result entity @e[type=area_effect_cloud, tag=blastoff_initial_position, limit=1, sort=nearest] Pos[2] double 1 run scoreboard players get @s _tmp.blastoff.player_initial_pos_z
...
scoreboard objectives remove _tmp.blastoff.player_initial_pos_x
scoreboard objectives remove _tmp.blastoff.player_initial_pos_y
scoreboard objectives remove _tmp.blastoff.player_initial_pos_z
