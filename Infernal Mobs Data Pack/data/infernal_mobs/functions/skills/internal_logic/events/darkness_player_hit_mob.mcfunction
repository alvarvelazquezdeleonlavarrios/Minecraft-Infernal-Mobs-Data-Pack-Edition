...
execute if score @e[tag=darkness, limit=1, sort=nearest, distance=..30] _skills.darkness.current_chance matches 20..89 if entity @s[gamemode=survival] unless entity @s[nbt={ActiveEffects:[{Id:15}]}] run effect give @s blindness 5 1 true
