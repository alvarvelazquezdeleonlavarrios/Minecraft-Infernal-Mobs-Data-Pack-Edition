...
execute if score @s _tmp.random_suffix.ender matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theEnderborn","interpret":true}'
execute if score @s _tmp.random_suffix.ender matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theTrickster","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
