...
execute if score @s _tmp.random_suffix.alchemist matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theWitchkin","interpret":true}'
execute if score @s _tmp.random_suffix.alchemist matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theBrewmaster","interpret":true}'
execute if score @s _tmp.random_suffix.alchemist matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theSinged","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
