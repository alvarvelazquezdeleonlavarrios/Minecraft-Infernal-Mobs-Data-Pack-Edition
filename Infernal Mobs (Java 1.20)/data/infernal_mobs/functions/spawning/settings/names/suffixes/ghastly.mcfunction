...
execute if score @s _tmp.random_suffix.ghastly matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" OMFGFIREBALLS","interpret":true}'
execute if score @s _tmp.random_suffix.ghastly matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theBomber","interpret":true}'
execute if score @s _tmp.random_suffix.ghastly matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofBallsofFire","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
