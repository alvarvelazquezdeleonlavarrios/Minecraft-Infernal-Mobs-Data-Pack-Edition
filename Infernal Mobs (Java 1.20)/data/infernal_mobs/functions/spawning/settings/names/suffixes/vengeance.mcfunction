...
execute if score @s _tmp.random_suffix.vengeance matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofRetribution","interpret":true}'
execute if score @s _tmp.random_suffix.vengeance matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theThorned","interpret":true}'
execute if score @s _tmp.random_suffix.vengeance matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofStrikingBack","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
