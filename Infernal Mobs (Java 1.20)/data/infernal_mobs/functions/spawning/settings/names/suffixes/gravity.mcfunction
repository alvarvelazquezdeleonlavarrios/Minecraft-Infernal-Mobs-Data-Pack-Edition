...
execute if score @s _tmp.random_suffix.gravity matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofRepulsion","interpret":true}'
execute if score @s _tmp.random_suffix.gravity matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theFlipper","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
