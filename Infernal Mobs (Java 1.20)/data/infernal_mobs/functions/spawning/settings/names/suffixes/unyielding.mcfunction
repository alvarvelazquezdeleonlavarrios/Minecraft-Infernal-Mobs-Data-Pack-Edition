...
execute if score @s _tmp.random_suffix.unyielding matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofHeavyMetal","interpret":true}'
execute if score @s _tmp.random_suffix.unyielding matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theAnvilOne","interpret":true}'
execute if score @s _tmp.random_suffix.unyielding matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" lordOfTanks","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
