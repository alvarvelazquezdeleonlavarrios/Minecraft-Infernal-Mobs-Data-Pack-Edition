...
scoreboard objectives add _tmp.random_suffix.regen dummy
scoreboard players set @s _tmp.random_suffix.regen -1
...
execute store result score @s _tmp.random_suffix.regen run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_suffix_regen, limit=1] UUID[0] 1
scoreboard players operation @s _tmp.random_suffix.regen %= $Constants _const.3
...
execute if score @s _tmp.random_suffix.regen matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofWTFIMBA","interpret":true}'
execute if score @s _tmp.random_suffix.regen matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theCancerous","interpret":true}'
execute if score @s _tmp.random_suffix.regen matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofFirstAid","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
scoreboard objectives remove _tmp.random_suffix.regen
