...
execute if score @s _tmp.random_suffix.rust matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofDecay","interpret":true}'
execute if score @s _tmp.random_suffix.rust matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theEquipmentHaunter","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
