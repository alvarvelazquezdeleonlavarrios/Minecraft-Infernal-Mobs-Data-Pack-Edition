...
execute if score @s _tmp.random_suffix.berserk matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofRecklessness","interpret":true}'
execute if score @s _tmp.random_suffix.berserk matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theRaging","interpret":true}'
execute if score @s _tmp.random_suffix.berserk matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofSmashing","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
