...
execute if score @s _tmp.random_suffix.poisonous matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofVenom","interpret":true}'
execute if score @s _tmp.random_suffix.poisonous matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" thedeadlyChalice","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
