...
execute if score @s _tmp.random_suffix.darkness matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofDarkness","interpret":true}'
execute if score @s _tmp.random_suffix.darkness matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theShadow","interpret":true}'
execute if score @s _tmp.random_suffix.darkness matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theEclipse","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
