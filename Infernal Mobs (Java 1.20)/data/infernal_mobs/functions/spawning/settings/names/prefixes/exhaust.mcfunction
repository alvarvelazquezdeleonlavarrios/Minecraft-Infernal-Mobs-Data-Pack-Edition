...
execute if score @s _tmp.random_prefix.exhaust matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"exhausting ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.exhaust matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"draining ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
