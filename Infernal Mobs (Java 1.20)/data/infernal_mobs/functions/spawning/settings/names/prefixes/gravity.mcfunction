...
execute if score @s _tmp.random_prefix.gravity matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"repulsing ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.gravity matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"sproing ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
