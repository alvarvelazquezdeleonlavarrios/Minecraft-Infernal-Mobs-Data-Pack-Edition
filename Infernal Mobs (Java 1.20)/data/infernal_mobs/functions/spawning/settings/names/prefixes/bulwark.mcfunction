...
execute if score @s _tmp.random_prefix.bulwark matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"turtling ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.bulwark matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"defensive ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.bulwark matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"armoured ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
