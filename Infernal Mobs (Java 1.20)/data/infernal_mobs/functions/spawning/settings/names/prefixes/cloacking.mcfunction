...
execute if score @s _tmp.random_prefix.cloacking matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"stalking ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.cloacking matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"unseen ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.cloacking matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"hunting ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
