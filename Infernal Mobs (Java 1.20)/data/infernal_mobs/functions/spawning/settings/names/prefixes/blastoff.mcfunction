...
execute if score @s _tmp.random_prefix.blastoff matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"thumping ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.blastoff matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"trolling ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.blastoff matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"byebye ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
