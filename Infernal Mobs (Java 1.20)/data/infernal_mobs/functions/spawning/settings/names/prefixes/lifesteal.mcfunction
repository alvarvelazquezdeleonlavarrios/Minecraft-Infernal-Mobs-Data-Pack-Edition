...
execute if score @s _tmp.random_prefix.lifesteal matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"vampiric ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.lifesteal matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"transfusing ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.lifesteal matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"bloodsucking ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
