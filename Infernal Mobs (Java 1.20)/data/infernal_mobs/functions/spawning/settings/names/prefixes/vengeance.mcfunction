...
execute if score @s _tmp.random_prefix.vengeance matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"thorned ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.vengeance matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"thorny ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.vengeance matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"spiky ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
