...
scoreboard objectives add _tmp.random_prefix.ghastly dummy
scoreboard players set @s _tmp.random_prefix.ghastly -1
...
execute store result score @s _tmp.random_prefix.ghastly run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_prefix_ghastly, limit=1] UUID[0] 1
scoreboard players operation @s _tmp.random_prefix.ghastly %= $Constants _const.2
...
execute if score @s _tmp.random_prefix.ghastly matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"bombing ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.ghastly matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"fireballsy ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
scoreboard objectives remove _tmp.random_prefix.ghastly
