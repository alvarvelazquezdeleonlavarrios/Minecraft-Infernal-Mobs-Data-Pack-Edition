...
execute if score @s _tmp.random_prefix.poisonous matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"poisonous ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.poisonous matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"stinging ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.poisonous matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"despoiling ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
