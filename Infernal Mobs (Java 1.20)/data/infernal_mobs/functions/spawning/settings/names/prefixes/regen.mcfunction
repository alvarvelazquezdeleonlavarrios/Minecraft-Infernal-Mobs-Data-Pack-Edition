...
execute if score @s _tmp.random_prefix.regen matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"regenerating ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.regen matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"healing ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.regen matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"nighunkillable ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
