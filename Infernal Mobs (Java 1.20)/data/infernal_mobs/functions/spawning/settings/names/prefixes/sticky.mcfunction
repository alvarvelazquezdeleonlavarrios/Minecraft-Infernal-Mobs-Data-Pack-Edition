...
execute if score @s _tmp.random_prefix.sticky matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"thieving ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.sticky matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"snagging ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.sticky matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"quickfingered ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
