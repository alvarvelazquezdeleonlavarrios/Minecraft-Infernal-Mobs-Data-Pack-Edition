...
execute if score @s _tmp.random_prefix.1up matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"recurring ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.1up matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"undying ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.1up matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"twinlived ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
