...
execute if score @s _tmp.random_prefix.rust matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"rusting ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.rust matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"decaying ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
