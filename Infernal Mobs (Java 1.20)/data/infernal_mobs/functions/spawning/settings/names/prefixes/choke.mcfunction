...
execute if score @s _tmp.random_prefix.choke matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"Sith Lord ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.choke matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"Dark Lord ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.choke matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"Darth ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
