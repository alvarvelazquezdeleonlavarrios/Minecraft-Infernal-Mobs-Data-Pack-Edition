...
execute if score @s _tmp.random_prefix.unyielding matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"heavy ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.unyielding matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"obese ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.unyielding matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"tanky ","interpret":true},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
