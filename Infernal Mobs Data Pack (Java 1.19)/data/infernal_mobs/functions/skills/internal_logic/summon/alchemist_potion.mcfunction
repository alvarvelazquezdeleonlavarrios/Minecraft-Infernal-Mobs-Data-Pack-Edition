...
execute if entity @a[gamemode=survival, limit=1, sort=nearest, distance=..40, scores={_health_points=8..}, nbt=!{ActiveEffects:[{Id:19}]}] run scoreboard players set @s _tmp.alchemist.current_potion_id 1
...
execute if entity @a[gamemode=survival, limit=1, sort=nearest, distance=8..40, nbt=!{ActiveEffects:[{Id:2}]}] run scoreboard players set @s _tmp.alchemist.current_potion_id 2
...
execute if entity @a[gamemode=survival, limit=1, sort=nearest, distance=..3, nbt=!{ActiveEffects:[{Id:18}]}] run scoreboard players set @s _tmp.alchemist.current_potion_id 3
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
execute if score @s _tmp.alchemist.current_potion_id matches 0 run summon potion ~ ~1 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:harming"}}}

#------- Summons a "Poison" potion -------
# if (tmp_alchemist_current_potion_id == 1):
#   Potion potion = new Potion("Poison");
execute if score @s _tmp.alchemist.current_potion_id matches 1 run summon potion ~ ~1 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:poison"}}}

#------- Summons a "Slowness" potion -------
# if (tmp_alchemist_current_potion_id == 2):
#   Potion potion = new Potion("Slowness");
execute if score @s _tmp.alchemist.current_potion_id matches 2 run summon potion ~ ~1 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:slowness"}}}

#------- Summons a "Weakness" potion (default) -------
# if (tmp_alchemist_current_potion_id == 3):
#   Potion potion = new Potion("Weakness");
execute if score @s _tmp.alchemist.current_potion_id matches 3 run summon potion ~ ~1 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:weakness"}}}
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
