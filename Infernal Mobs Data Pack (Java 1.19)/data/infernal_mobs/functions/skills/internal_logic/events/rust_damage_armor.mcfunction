...
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] ArmorItems[0].tag.Damage int 1 run scoreboard players get @s _tmp.rust.armor_feet_current_damage
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] ArmorItems[1].tag.Damage int 1 run scoreboard players get @s _tmp.rust.armor_legs_current_damage
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] ArmorItems[2].tag.Damage int 1 run scoreboard players get @s _tmp.rust.armor_body_current_damage
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] ArmorItems[3].tag.Damage int 1 run scoreboard players get @s _tmp.rust.armor_head_current_damage
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] HandItems[1].tag.Damage int 1 run scoreboard players get @s _tmp.rust.armor_left_hand_current_damage
