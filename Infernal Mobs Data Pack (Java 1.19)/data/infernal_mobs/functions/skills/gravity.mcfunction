...
execute as @p[gamemode=survival, distance=..40] at @s rotated ~ 0.0 positioned ^ ^1501.4 ^0.6 run function infernal_mobs:skills/internal_logic/physics/apply_force_to_player
