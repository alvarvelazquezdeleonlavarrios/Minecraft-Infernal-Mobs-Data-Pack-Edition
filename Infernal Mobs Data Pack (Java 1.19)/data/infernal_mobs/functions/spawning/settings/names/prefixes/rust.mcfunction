...
execute if score @s _tmp.random_prefix.rust matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"rusting ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.rust matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"decaying ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
