...
execute if score @s _tmp.random_prefix.exhaust matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"exhausting ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.exhaust matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"draining ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
