...
execute if score @s _tmp.random_prefix.sprint matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"sprinting ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.sprint matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"swift ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.sprint matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"charging ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
