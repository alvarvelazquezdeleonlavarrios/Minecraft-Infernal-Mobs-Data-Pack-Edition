...
execute if score @s _tmp.random_suffix.regen matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofWTFIMBA","interpret":true}'
execute if score @s _tmp.random_suffix.regen matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theCancerous","interpret":true}'
execute if score @s _tmp.random_suffix.regen matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" ofFirstAid","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
