...
execute if score @s _tmp.random_suffix.ninja matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" theZenMaster","interpret":true}'
execute if score @s _tmp.random_suffix.ninja matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" ofEquilibrium","interpret":true}'
execute if score @s _tmp.random_suffix.ninja matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" ofInnerPeace","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
