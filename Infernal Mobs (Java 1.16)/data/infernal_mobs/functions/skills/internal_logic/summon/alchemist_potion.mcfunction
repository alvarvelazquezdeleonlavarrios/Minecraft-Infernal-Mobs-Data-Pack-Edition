...
execute if score @s _tmp.alch.crtPId matches 0 run summon potion ~ ~1 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:harming"}}}

#------- Summons a "Poison" potion -------
# if (tmp_alchemist_current_potion_id == 1):
#   Potion potion = new Potion("Poison");
execute if score @s _tmp.alch.crtPId matches 1 run summon potion ~ ~1 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:poison"}}}

#------- Summons a "Slowness" potion -------
# if (tmp_alchemist_current_potion_id == 2):
#   Potion potion = new Potion("Slowness");
execute if score @s _tmp.alch.crtPId matches 2 run summon potion ~ ~1 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:slowness"}}}

#------- Summons a "Weakness" potion (default) -------
# if (tmp_alchemist_current_potion_id == 3):
#   Potion potion = new Potion("Weakness");
execute if score @s _tmp.alch.crtPId matches 3 run summon potion ~ ~1 ~ {Item:{id:"minecraft:splash_potion",Count:1b,tag:{Potion:"minecraft:weakness"}}}
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
