...
scoreboard players operation @s _tmp.hltMult *= $Constants _const.16
...
execute store result entity @s Attributes[{Name:"minecraft:generic.max_health"}].Base double 1 run scoreboard players get @s _tmp.newHealth
