...
execute as @e[type=area_effect_cloud, tag=infernal_mob_death_detector, tag=ultra, limit=1, sort=nearest, distance=..1] run scoreboard players set @s _aecDthD.bndMob 1
execute as @e[type=area_effect_cloud, tag=infernal_mob_death_detector, tag=ultra, limit=1, sort=nearest, distance=..1] run scoreboard players set @s _aecDthD.xpOrbsA 9
