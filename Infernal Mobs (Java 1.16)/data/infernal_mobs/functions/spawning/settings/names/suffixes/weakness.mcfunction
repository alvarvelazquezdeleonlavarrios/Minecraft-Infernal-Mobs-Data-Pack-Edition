...
execute store result score @s _tmp.rndSuf.wkns run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_suffix_weakness, limit=1] UUID[0] 1
