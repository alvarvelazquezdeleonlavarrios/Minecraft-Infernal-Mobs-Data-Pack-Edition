...
execute if entity @s[tag=alchemist, scores={_sk.alch.crtT=1}, predicate=infernal_mobs:chasing_player] at @s run function infernal_mobs:skills/alchemist
...
execute if entity @s[tag=alchemist, scores={_sk.alch.crtT=1..}, predicate=infernal_mobs:chasing_player] run scoreboard players remove @s _sk.alch.crtT 1
...
execute if entity @s[tag=alchemist, scores={_sk.alch.crtT=..0}, predicate=infernal_mobs:chasing_player] run scoreboard players operation @s _sk.alch.crtT = @s _sk.alch.mxT
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#   mob.skills.Blastoff();
execute if entity @s[tag=blastoff, scores={_sk.blst.crtT=1}, predicate=infernal_mobs:chasing_player] at @s run function infernal_mobs:skills/blastoff

#------- If the current timer hasn't finished, decreases its value -------
# if (mob.tags.Find("blastoff") == true && mob.blastoff_current_time >= 1 && mob.isChasingPlayer() == true):
#   mob.blastoff_current_time--;
execute if entity @s[tag=blastoff, scores={_sk.blst.crtT=1..}, predicate=infernal_mobs:chasing_player] run scoreboard players remove @s _sk.blst.crtT 1
...
execute if entity @s[tag=blastoff, scores={_sk.blst.crtT=..0}, predicate=infernal_mobs:chasing_player] run scoreboard players operation @s _sk.blst.crtT = @s _sk.blst.mxT
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
execute if entity @s[tag=cloacking, scores={_sk.clck.crtT=1}, predicate=infernal_mobs:chasing_player] at @s run function infernal_mobs:skills/cloacking

#------- If the current timer hasn't finished, decreases its value -------
# if (mob.tags.Find("cloacking") == true && mob.cloacking_current_time >= 1 && mob.isChasingPlayer() == true):
#   mob.cloacking_current_time--;
execute if entity @s[tag=cloacking, scores={_sk.clck.crtT=1..}, predicate=infernal_mobs:chasing_player] run scoreboard players remove @s _sk.clck.crtT 1
...
execute if entity @s[tag=cloacking, scores={_sk.clck.crtT=..0}, predicate=infernal_mobs:chasing_player] run scoreboard players operation @s _sk.clck.crtT = @s _sk.clck.mxT
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#   mob.skills.ghastly();
execute if entity @s[tag=ghastly, scores={_sk.ghtl.crtT=..0}, predicate=infernal_mobs:chasing_player] at @s if entity @p[gamemode=survival, distance=3..40] run function infernal_mobs:skills/ghastly

#------- If the current timer hasn't finished, decreases its value -------
# if (mob.tags.Find("ghastly") == true && mob.ghastly_current_time >= 1):
#   mob.ghastly_current_time--;
execute if entity @s[tag=ghastly, scores={_sk.ghtl.crtT=1..}, predicate=infernal_mobs:chasing_player] run scoreboard players remove @s _sk.ghtl.crtT 1
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#   mob.skills.gravity();
execute if entity @s[tag=gravity, scores={_sk.grvt.crtT=1}, predicate=infernal_mobs:chasing_player] at @s run function infernal_mobs:skills/gravity

#------- If the current timer hasn't finished, decreases its value -------
# if (mob.tags.Find("gravity") == true && mob.gravity_current_time >= 1 && mob.isChasingPlayer() == true):
#   mob.gravity_current_time--;
execute if entity @s[tag=gravity, scores={_sk.grvt.crtT=1..}, predicate=infernal_mobs:chasing_player] run scoreboard players remove @s _sk.grvt.crtT 1
...
execute if entity @s[tag=gravity, scores={_sk.grvt.crtT=..0}, predicate=infernal_mobs:chasing_player] run scoreboard players operation @s _sk.grvt.crtT = @s _sk.grvt.mxT
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
execute if entity @s[tag=lifesteal] run execute store result score @s _sk.lfst.atkDmg run data get entity @s Attributes[{Name:"minecraft:generic.attack_damage"}].Base 1
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
execute if entity @s[tag=quicksand, scores={_sk.qucksnd.crtT=1}, predicate=infernal_mobs:chasing_player] at @s run function infernal_mobs:skills/quicksand

#------- If the current timer hasn't finished, decreases its value -------
# if (mob.tags.Find("quicksand") == true && mob.quicksand_current_time >= 1 && mob.isChasingPlayer() == true):
#   mob.quicksand_current_time--;
execute if entity @s[tag=quicksand, scores={_sk.qucksnd.crtT=1..}, predicate=infernal_mobs:chasing_player] run scoreboard players remove @s _sk.qucksnd.crtT 1
...
execute if entity @s[tag=quicksand, scores={_sk.qucksnd.crtT=..0}, predicate=infernal_mobs:chasing_player] run scoreboard players operation @s _sk.qucksnd.crtT = @s _sk.qucksnd.mxT
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#   mob.skills.storm();
execute if entity @s[tag=storm, scores={_sk.storm.crtT=..0}, predicate=infernal_mobs:chasing_player] at @s if entity @p[gamemode=survival, distance=5..40] run function infernal_mobs:skills/storm

#------- If the current timer hasn't finished, decreases its value -------
# if (mob.tags.Find("storm") == true && mob.storm_current_time >= 1):
#   mob.storm_current_time--;
execute if entity @s[tag=storm, scores={_sk.storm.crtT=1..}, predicate=infernal_mobs:chasing_player] run scoreboard players remove @s _sk.storm.crtT 1
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
execute if entity @s[tag=webber, scores={_sk.webber.crtT=1}, predicate=infernal_mobs:chasing_player] at @p[gamemode=survival, distance=..40] run function infernal_mobs:skills/webber

#------- If the current timer hasn't finished, decreases its value -------
# if (mob.tags.Find("webber") == true && mob.webber_current_time >= 1):
#   mob.webber_current_time--;
execute if entity @s[tag=webber, scores={_sk.webber.crtT=1..}, predicate=infernal_mobs:chasing_player] run scoreboard players remove @s _sk.webber.crtT 1
...
execute if entity @s[tag=webber, scores={_sk.webber.crtT=..0}, predicate=infernal_mobs:chasing_player] run scoreboard players operation @s _sk.webber.crtT = @s _sk.webber.mxT
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
