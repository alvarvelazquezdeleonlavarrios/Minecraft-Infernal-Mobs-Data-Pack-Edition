...
scoreboard objectives add _tmp.blstPPosX dummy
scoreboard objectives add _tmp.blstPPosY dummy
scoreboard objectives add _tmp.blstPPosZ dummy
...
# player.AddVariable( _tmp_blastoff_player_initial_pos_y, 0 );
scoreboard players set @s _tmp.blstPPosX 0
scoreboard players set @s _tmp.blstPPosY 0
scoreboard players set @s _tmp.blstPPosZ 0
...
execute store result score @s _tmp.blstPPosX run data get entity @s Pos[0]
execute store result score @s _tmp.blstPPosY run data get entity @s Pos[1]
execute store result score @s _tmp.blstPPosZ run data get entity @s Pos[2]
