...
scoreboard objectives add _tmp.rustAFCrtD dummy
scoreboard objectives add _tmp.rustALCrtD dummy
scoreboard objectives add _tmp.rustABCrtD dummy
scoreboard objectives add _tmp.rustAHCrtD dummy
scoreboard objectives add _tmp.rustALHCrtD dummy
...
scoreboard players set @s _tmp.rustAFCrtD 0
scoreboard players set @s _tmp.rustALCrtD 0
scoreboard players set @s _tmp.rustABCrtD 0
scoreboard players set @s _tmp.rustAHCrtD 0
scoreboard players set @s _tmp.rustALHCrtD 0
...
execute store result score @s _tmp.rustAFCrtD run data get entity @s Inventory[{Slot:100b}].tag.Damage
execute store result score @s _tmp.rustALCrtD run data get entity @s Inventory[{Slot:101b}].tag.Damage
execute store result score @s _tmp.rustABCrtD run data get entity @s Inventory[{Slot:102b}].tag.Damage
execute store result score @s _tmp.rustAHCrtD run data get entity @s Inventory[{Slot:103b}].tag.Damage
execute store result score @s _tmp.rustALHCrtD run data get entity @s Inventory[{Slot:-106b}].tag.Damage
...
scoreboard players operation @s _tmp.rustAFCrtD += $Constants _const.4
scoreboard players operation @s _tmp.rustALCrtD += $Constants _const.4
scoreboard players operation @s _tmp.rustABCrtD += $Constants _const.4
scoreboard players operation @s _tmp.rustAHCrtD += $Constants _const.4
scoreboard players operation @s _tmp.rustALHCrtD += $Constants _const.4
...
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] ArmorItems[0].tag.Damage int 1 run scoreboard players get @s _tmp.rustAFCrtD
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] ArmorItems[1].tag.Damage int 1 run scoreboard players get @s _tmp.rustALCrtD
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] ArmorItems[2].tag.Damage int 1 run scoreboard players get @s _tmp.rustABCrtD
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] ArmorItems[3].tag.Damage int 1 run scoreboard players get @s _tmp.rustAHCrtD
execute store result entity @e[type=villager, tag=rust_mob_hit_player, limit=1, sort=nearest] HandItems[1].tag.Damage int 1 run scoreboard players get @s _tmp.rustALHCrtD
...
scoreboard objectives remove _tmp.rustAFCrtD
scoreboard objectives remove _tmp.rustALCrtD
scoreboard objectives remove _tmp.rustABCrtD
scoreboard objectives remove _tmp.rustAHCrtD
scoreboard objectives remove _tmp.rustALHCrtD
