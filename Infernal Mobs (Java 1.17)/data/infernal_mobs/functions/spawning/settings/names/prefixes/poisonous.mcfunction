...
execute store result score @s _tmp.rndPre.psns run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_prefix_poisonous, limit=1] UUID[0] 1
