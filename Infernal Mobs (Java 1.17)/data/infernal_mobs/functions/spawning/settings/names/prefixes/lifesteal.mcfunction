...
execute store result score @s _tmp.rndPre.lfst run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_prefix_lifesteal, limit=1] UUID[0] 1
