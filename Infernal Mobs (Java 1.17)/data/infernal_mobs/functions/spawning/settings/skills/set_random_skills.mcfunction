...
scoreboard players operation @s _tmp.crtSk %= $Constants _const.27
...
execute if score @s _tmp.crtSk matches 17 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=rust] run function infernal_mobs:spawning/settings/skills/add_rust
...
execute if score @s _tmp.crtSk matches 18 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=sapper] run function infernal_mobs:spawning/settings/skills/add_sapper
...
execute if score @s _tmp.crtSk matches 19 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=sprint] run function infernal_mobs:spawning/settings/skills/add_sprint
...
execute if score @s _tmp.crtSk matches 20 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=sticky] run function infernal_mobs:spawning/settings/skills/add_sticky
...
execute if score @s _tmp.crtSk matches 21 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=storm] run function infernal_mobs:spawning/settings/skills/add_storm
...
execute if score @s _tmp.crtSk matches 22 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=unyielding] run function infernal_mobs:spawning/settings/skills/add_unyielding
...
execute if score @s _tmp.crtSk matches 23 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=vengeance] run function infernal_mobs:spawning/settings/skills/add_vengeance
...
execute if score @s _tmp.crtSk matches 24 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=weakness] run function infernal_mobs:spawning/settings/skills/add_weakness
...
execute if score @s _tmp.crtSk matches 25 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=webber] run function infernal_mobs:spawning/settings/skills/add_webber
...
execute if score @s _tmp.crtSk matches 26 if score @s _tmp.skCnt matches 1.. unless entity @s[tag=wither] run function infernal_mobs:spawning/settings/skills/add_wither
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
