...
execute if entity @s[tag=rare] run data modify block ~ ~ ~ Text1 set value '[{"text":"Rare ","color":"aqua"},{"nbt":"Text2","block":"~ ~ ~","interpret":true,"color":"aqua"},{"nbt":"Text1","block":"~ ~ ~","interpret":true,"color":"white"}]'

#------- Adds the final text for a ultra mob -------
# if (mob.Tags.Find("ultra")):
#   sign.text1 = "Ultra " + sign.text2 + sign.text1;
execute if entity @s[tag=ultra] run data modify block ~ ~ ~ Text1 set value '[{"text":"Ultra ","color":"yellow"},{"nbt":"Text2","block":"~ ~ ~","interpret":true,"color":"yellow"},{"nbt":"Text1","block":"~ ~ ~","interpret":true,"color":"white"}]'

#------- Adds the final text for a infernal mob -------
# if (mob.Tags.Find("infernal")):
#   sign.text1 = "Infernal " + sign.text2 + sign.text1;
execute if entity @s[tag=infernal] run data modify block ~ ~ ~ Text1 set value '[{"text":"Infernal ","color":"red"},{"nbt":"Text2","block":"~ ~ ~","interpret":true,"color":"red"},{"nbt":"Text1","block":"~ ~ ~","interpret":true,"color":"white"}]'
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
#   kill( mob );
execute if score $Healthbars _hb.alrFound matches 0 run tp @s ~ ~-1000 ~
execute if score $Healthbars _hb.alrFound matches 0 run kill @s
