...
execute store result score @s _sk.ghtl.crtT run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=add_ghastly, limit=1] UUIDLeast 0.00000000023283064365386962890625
