...
execute store result score @s _tmp.skCnt run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=spawn_ultra, limit=1] UUIDLeast 0.00000000023283064365386962890625
scoreboard players operation @s _tmp.skCnt %= $Constants _const.4
scoreboard players operation @s _tmp.skCnt += $Constants _const.5
