...
execute if entity @s[type=enderman] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:5}]}
execute if entity @s[type=slime] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:3}]}
...
execute if entity @s[type=vindicator] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:8}]}
execute if entity @s[type=evoker] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:6}]}
execute if entity @s[type=vex] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:6}]}
execute if entity @s[type=ravager] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:7.5}]}

#------- Overworld updates mobs. -------
execute if entity @s[type=drowned] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:3}]}
execute if entity @s[type=husk] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:3}]}
...
execute if entity @s[type=blaze] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:4.5}]}
execute if entity @s[type=magma_cube] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:4.5}]}
execute if entity @s[type=zombified_piglin] run data merge entity @s {Attributes:[{Name:"minecraft:generic.attack_damage",Base:5.5}]}
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
