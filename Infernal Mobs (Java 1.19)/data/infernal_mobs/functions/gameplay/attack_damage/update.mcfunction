...
execute if score $GameManager _game_difficulty.current_value matches 1 run function infernal_mobs:gameplay/attack_damage/update_by_difficulty/easy
...
execute if score $GameManager _game_difficulty.current_value matches 2 run function infernal_mobs:gameplay/attack_damage/update_by_difficulty/normal
...
execute if score $GameManager _game_difficulty.current_value matches 3 run function infernal_mobs:gameplay/attack_damage/update_by_difficulty/hard
