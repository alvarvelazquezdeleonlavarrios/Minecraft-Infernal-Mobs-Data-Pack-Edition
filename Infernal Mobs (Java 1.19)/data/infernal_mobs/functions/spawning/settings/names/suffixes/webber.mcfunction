...
execute if score @s _tmp.random_suffix.webber matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofTraps","interpret":true}'
execute if score @s _tmp.random_suffix.webber matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theMutated","interpret":true}'
execute if score @s _tmp.random_suffix.webber matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" theSpider","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
