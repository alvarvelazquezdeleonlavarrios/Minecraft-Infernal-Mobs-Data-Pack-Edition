...
execute if score @s _tmp.random_suffix.lifesteal matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" theVampire","interpret":true}'
execute if score @s _tmp.random_suffix.lifesteal matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" ofTransfusion","interpret":true}'
execute if score @s _tmp.random_suffix.lifesteal matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" theBloodsucker","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
