...
execute if score @s _tmp.random_prefix.darkness matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"dark ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.darkness matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"shadowkin ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.darkness matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"eclipsed ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
