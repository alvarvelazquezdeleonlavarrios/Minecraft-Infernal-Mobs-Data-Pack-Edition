...
execute if score @s _tmp.random_prefix.storm matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"striking ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.storm matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"thundering ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.storm matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"electrified ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
