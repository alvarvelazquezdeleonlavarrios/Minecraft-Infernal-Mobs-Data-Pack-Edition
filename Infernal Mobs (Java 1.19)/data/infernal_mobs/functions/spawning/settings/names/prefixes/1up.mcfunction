...
execute if score @s _tmp.random_prefix.1up matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"recurring ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.1up matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"undying ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.1up matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"twinlived ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
