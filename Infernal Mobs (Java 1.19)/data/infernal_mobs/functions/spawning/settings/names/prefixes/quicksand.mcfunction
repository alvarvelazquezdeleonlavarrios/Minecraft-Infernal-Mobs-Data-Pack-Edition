...
execute if score @s _tmp.random_prefix.quicksand matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"slowing ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.quicksand matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"Quicksand ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
