...
execute if score @s _tmp.random_prefix.regen matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"regenerating ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.regen matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"healing ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.regen matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"nighunkillable ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
