...
execute if score @s _tmp.random_prefix.gravity matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"repulsing ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.gravity matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"sproing ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
