...
execute if score @s _tmp.random_prefix.weakness matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"apathetic "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.weakness matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"deceiving "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
