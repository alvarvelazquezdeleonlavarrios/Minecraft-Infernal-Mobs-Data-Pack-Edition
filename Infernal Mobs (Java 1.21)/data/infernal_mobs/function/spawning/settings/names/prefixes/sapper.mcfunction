...
execute if score @s _tmp.random_prefix.sapper matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"hungering "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.sapper matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"starving "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
