...
execute if score @s _tmp.random_prefix.ender matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"enderborn "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.ender matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"tricky "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
