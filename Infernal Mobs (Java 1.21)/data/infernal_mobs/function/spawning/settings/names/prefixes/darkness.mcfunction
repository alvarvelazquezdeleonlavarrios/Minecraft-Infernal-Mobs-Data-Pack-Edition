...
execute if score @s _tmp.random_prefix.darkness matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"dark "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.darkness matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"shadowkin "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.darkness matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"eclipsed "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
