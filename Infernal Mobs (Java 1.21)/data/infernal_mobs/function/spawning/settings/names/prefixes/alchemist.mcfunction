...
execute if score @s _tmp.random_prefix.alchemist matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"witchkin "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.alchemist matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"brewing "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.alchemist matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"singed "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
