...
execute if score @s _tmp.random_prefix.fiery matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"burning "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.fiery matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"toasting "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
