...
execute if score @s _tmp.random_prefix.berserk matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"reckless "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.berserk matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"raging "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.berserk matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"smashing "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
