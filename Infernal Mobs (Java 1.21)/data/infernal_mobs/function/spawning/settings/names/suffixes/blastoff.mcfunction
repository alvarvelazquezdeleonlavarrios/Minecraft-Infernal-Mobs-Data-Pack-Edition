...
execute if score @s _tmp.random_suffix.blastoff matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofMissionControl"}'
execute if score @s _tmp.random_suffix.blastoff matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theNASA"}'
execute if score @s _tmp.random_suffix.blastoff matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofWEE"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
