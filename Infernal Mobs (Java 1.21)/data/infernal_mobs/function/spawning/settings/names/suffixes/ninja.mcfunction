...
execute if score @s _tmp.random_suffix.ninja matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theZenMaster"}'
execute if score @s _tmp.random_suffix.ninja matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofEquilibrium"}'
execute if score @s _tmp.random_suffix.ninja matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofInnerPeace"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
