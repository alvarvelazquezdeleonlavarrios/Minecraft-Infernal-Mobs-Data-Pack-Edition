...
execute if score @s _tmp.random_suffix.sprint matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofBolting"}'
execute if score @s _tmp.random_suffix.sprint matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theSwiftOne"}'
execute if score @s _tmp.random_suffix.sprint matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofbeinginyourFace"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
