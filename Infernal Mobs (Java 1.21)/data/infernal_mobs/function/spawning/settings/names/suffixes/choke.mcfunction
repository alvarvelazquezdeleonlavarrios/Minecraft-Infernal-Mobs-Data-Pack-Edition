...
execute if score @s _tmp.random_suffix.choke matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofBreathlessness"}'
execute if score @s _tmp.random_suffix.choke matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theAnaerobic"}'
execute if score @s _tmp.random_suffix.choke matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofDeprivation"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
