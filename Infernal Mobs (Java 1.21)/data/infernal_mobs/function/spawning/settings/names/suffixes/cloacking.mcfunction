...
execute if score @s _tmp.random_suffix.cloacking matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofStalking"}'
execute if score @s _tmp.random_suffix.cloacking matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theUnseen"}'
execute if score @s _tmp.random_suffix.cloacking matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" thePredator"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
