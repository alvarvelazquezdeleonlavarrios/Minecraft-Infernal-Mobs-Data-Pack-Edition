...
execute if score @s _tmp.random_suffix.weakness matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofApathy"}'
execute if score @s _tmp.random_suffix.weakness matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theDeceiver"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
