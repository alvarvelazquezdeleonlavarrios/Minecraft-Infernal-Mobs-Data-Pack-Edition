...
execute if score @s _tmp.random_suffix.regen matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofWTFIMBA"}'
execute if score @s _tmp.random_suffix.regen matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theCancerous"}'
execute if score @s _tmp.random_suffix.regen matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofFirstAid"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
