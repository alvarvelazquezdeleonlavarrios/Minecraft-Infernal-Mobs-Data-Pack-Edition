...
scoreboard objectives add _skills.choke.max_time dummy
scoreboard objectives add _skills.choke.current_time dummy
scoreboard objectives add _skills.choke.current_drown_time dummy
...
scoreboard objectives add _const.28 dummy
...
scoreboard players set $Constants _const.28 28
...
tellraw @a {"text": "---------- For Minecraft: Java Edition v.1.21 -----------","color":"#D67520"}
