...
execute if entity @s[gamemode=survival, nbt=!{active_effects:[{id:"minecraft:wither"}]}] run effect give @s wither 6 0 true
...
advancement revoke @s only infernal_mobs:skills/wither/mob_hit_player
