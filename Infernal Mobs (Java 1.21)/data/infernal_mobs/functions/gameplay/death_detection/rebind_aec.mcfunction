...
execute if entity @s[tag=rare] run scoreboard players set @e[type=area_effect_cloud, tag=infernal_mob_death_detector, tag=rare, limit=1, sort=nearest, distance=..2, scores={_aec_death_detector.is_binded_to_mob=0}] _aec_death_detector.is_binded_to_mob 1
execute if entity @s[tag=ultra] run scoreboard players set @e[type=area_effect_cloud, tag=infernal_mob_death_detector, tag=ultra, limit=1, sort=nearest, distance=..2, scores={_aec_death_detector.is_binded_to_mob=0}] _aec_death_detector.is_binded_to_mob 1
execute if entity @s[tag=infernal] run scoreboard players set @e[type=area_effect_cloud, tag=infernal_mob_death_detector, tag=infernal, limit=1, sort=nearest, distance=..2, scores={_aec_death_detector.is_binded_to_mob=0}] _aec_death_detector.is_binded_to_mob 1
