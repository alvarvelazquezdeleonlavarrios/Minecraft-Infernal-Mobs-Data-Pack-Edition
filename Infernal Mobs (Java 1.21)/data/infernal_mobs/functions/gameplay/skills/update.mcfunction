...
execute if entity @s[tag=lifesteal] run execute store result score @s _skills.lifesteal.attack_damage run data get entity @s attributes[{id:"minecraft:generic.attack_damage"}].base 1
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
