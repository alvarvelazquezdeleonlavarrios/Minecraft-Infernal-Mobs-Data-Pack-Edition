...
execute if entity @s[gamemode=survival, nbt=!{active_effects:[{id:"minecraft:poison"}]}] run effect give @s poison 7 0 true
...
advancement revoke @s only infernal_mobs:skills/poisonous/player_hit_mob
