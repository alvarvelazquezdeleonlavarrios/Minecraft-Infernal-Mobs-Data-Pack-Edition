...
execute if score @s _tmp.random_prefix.wither matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"withering "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.wither matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"destroyer "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
