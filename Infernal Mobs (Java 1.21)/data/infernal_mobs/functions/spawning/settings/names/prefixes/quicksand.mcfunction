...
execute if score @s _tmp.random_prefix.quicksand matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"slowing "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.quicksand matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"Quicksand "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
