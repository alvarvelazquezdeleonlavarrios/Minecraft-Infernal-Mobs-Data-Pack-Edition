...
execute if score @s _tmp.random_prefix.ghastly matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"bombing "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.ghastly matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"fireballsy "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
