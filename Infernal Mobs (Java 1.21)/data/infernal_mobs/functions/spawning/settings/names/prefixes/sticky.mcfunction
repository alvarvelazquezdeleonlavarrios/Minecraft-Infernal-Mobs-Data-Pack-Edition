...
execute if score @s _tmp.random_prefix.sticky matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"thieving "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.sticky matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"snagging "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.sticky matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"quickfingered "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
