...
execute if score @s _tmp.random_prefix.webber matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"ensnaring "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.webber matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '[{"text":"webbing "},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
