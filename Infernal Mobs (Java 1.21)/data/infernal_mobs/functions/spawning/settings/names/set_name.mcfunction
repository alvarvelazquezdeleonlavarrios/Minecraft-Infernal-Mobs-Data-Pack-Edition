...
setblock ~ ~ ~ oak_sign{front_text:{messages:['{"text":""}','{"text":""}','{"text":""}','{"text":""}']}} replace
...
data modify block ~ ~ ~ front_text.messages[1] set value '[{"selector":"@e[tag=Infernal_Mob,limit=1,sort=nearest]"},{"nbt":"front_text.messages[1]","block":"~ ~ ~","interpret":true}]'
