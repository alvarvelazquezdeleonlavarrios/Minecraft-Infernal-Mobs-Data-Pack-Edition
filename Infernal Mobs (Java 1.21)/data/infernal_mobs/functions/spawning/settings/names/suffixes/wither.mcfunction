...
execute if score @s _tmp.random_suffix.wither matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofDarkSkulls"}'
execute if score @s _tmp.random_suffix.wither matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" Doomskull"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
