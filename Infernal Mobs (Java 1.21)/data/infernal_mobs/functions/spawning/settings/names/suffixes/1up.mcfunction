...
execute if score @s _tmp.random_suffix.1up matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofRecurrence"}'
execute if score @s _tmp.random_suffix.1up matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theUndying"}'
execute if score @s _tmp.random_suffix.1up matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" oftwinLives"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
