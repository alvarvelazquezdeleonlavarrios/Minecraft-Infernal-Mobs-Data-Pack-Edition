...
execute if score @s _tmp.random_suffix.sticky matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofSnagging"}'
execute if score @s _tmp.random_suffix.sticky matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theQuickFingered"}'
execute if score @s _tmp.random_suffix.sticky matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofPettyTheft"}'
execute if score @s _tmp.random_suffix.sticky matches 3 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" yoink"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
