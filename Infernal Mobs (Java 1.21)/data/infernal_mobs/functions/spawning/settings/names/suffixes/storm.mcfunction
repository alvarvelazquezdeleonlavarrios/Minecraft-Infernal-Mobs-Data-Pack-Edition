...
execute if score @s _tmp.random_suffix.storm matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofLightning"}'
execute if score @s _tmp.random_suffix.storm matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theRaiden"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
