...
execute if score @s _tmp.random_suffix.darkness matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofDarkness"}'
execute if score @s _tmp.random_suffix.darkness matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theShadow"}'
execute if score @s _tmp.random_suffix.darkness matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theEclipse"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
