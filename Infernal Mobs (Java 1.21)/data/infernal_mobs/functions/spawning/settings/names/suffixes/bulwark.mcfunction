...
execute if score @s _tmp.random_suffix.bulwark matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofTurtling"}'
execute if score @s _tmp.random_suffix.bulwark matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" theDefender"}'
execute if score @s _tmp.random_suffix.bulwark matches 2 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofeffingArmor"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
