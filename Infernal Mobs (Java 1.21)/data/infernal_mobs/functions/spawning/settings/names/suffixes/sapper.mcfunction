...
execute if score @s _tmp.random_suffix.sapper matches 0 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" ofHunger"}'
execute if score @s _tmp.random_suffix.sapper matches 1 run data modify block ~ ~ ~ front_text.messages[1] set value '{"text":" thePaleRider"}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
