...
execute if score @s _tmp.random_prefix.vengeance matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"thorned ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.vengeance matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"thorny ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.vengeance matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"spiky ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
