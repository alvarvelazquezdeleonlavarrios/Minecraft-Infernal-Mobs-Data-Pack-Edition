...
execute if score @s _tmp.random_prefix.unyielding matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"obese ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.unyielding matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"tanky ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
