...
execute if score @s _tmp.random_prefix.sapper matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"hungering ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.sapper matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"starving ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
