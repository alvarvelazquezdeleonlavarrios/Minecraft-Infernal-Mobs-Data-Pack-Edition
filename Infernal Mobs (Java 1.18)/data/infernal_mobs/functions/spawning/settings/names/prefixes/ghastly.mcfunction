...
execute if score @s _tmp.random_prefix.ghastly matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"bombing ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.ghastly matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"fireballsy ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
