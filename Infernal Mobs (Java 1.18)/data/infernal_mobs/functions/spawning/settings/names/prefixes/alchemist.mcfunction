...
execute if score @s _tmp.random_prefix.alchemist matches 0 run data modify block ~ ~ ~ Text2 set value '[{"text":"witchkin ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.alchemist matches 1 run data modify block ~ ~ ~ Text2 set value '[{"text":"brewing ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
execute if score @s _tmp.random_prefix.alchemist matches 2 run data modify block ~ ~ ~ Text2 set value '[{"text":"singed ","interpret":true},{"nbt":"Text2","block":"~ ~ ~","interpret":true}]'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
