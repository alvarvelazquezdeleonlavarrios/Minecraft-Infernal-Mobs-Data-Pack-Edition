...
execute if score @s _tmp.random_suffix.exhaust matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofFatigue","interpret":true}'
execute if score @s _tmp.random_suffix.exhaust matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theDrainer","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
