...
execute if score @s _tmp.random_suffix.weakness matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofApathy","interpret":true}'
execute if score @s _tmp.random_suffix.weakness matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theDeceiver","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
