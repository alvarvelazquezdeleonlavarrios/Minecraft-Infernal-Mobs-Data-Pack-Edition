...
execute if score @s _tmp.random_suffix.sticky matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofSnagging","interpret":true}'
execute if score @s _tmp.random_suffix.sticky matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theQuickFingered","interpret":true}'
execute if score @s _tmp.random_suffix.sticky matches 2 run data modify block ~ ~ ~ Text2 set value '{"text":" ofPettyTheft","interpret":true}'
execute if score @s _tmp.random_suffix.sticky matches 3 run data modify block ~ ~ ~ Text2 set value '{"text":" yoink","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
