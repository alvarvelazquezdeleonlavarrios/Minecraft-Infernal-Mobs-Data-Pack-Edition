...
execute if score @s _tmp.random_suffix.storm matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofLightning","interpret":true}'
execute if score @s _tmp.random_suffix.storm matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theRaiden","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
