...
execute if score @s _tmp.random_suffix.quicksand matches 0 run data modify block ~ ~ ~ Text2 set value '{"text":" ofYouCantRun","interpret":true}'
execute if score @s _tmp.random_suffix.quicksand matches 1 run data modify block ~ ~ ~ Text2 set value '{"text":" theSlowingB","interpret":true}'
#++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
