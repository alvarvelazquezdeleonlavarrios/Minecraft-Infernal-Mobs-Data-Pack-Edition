...
execute store result score @s _tmp.rust.selected_item_current_damage run data get entity @s SelectedItem.tag.Damage
...
execute store result entity @e[type=villager, tag=rust_player_hit_mob, limit=1, sort=nearest] HandItems[0].tag.Damage int 1 run scoreboard players get @s _tmp.rust.selected_item_current_damage
